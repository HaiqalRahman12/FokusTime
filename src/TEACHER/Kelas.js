...
import ModalComponentSukses from './components/ModalSukses';
...
const KelasGuru = ({ navigation }) => {
  ...
  const [username, setUsername] = useState('yusn009');
  ...
  return (
    <View style={styles.container}>
      ...
      <ModalComponentSukses isVisible={isModalVisible} onClose={handleCloseModal} username={username}/>
    </View>
  );
};
